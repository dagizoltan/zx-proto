...
import { TaskExecutionSchema } from '../../../../ctx/scheduler/infrastructure/persistence/schemas/task-execution.schema.js';
import { taskExecutionMapper } from '../../../../ctx/scheduler/infrastructure/persistence/mappers/task-execution.mapper.js';
...
export const createKVTaskExecutionRepository = (kvPool) => {
    ...
    return {
        save: async (tenantId, domainEntity) => {
            try {
                const persistenceModel = taskExecutionMapper.toPersistence(domainEntity, tenantId);
