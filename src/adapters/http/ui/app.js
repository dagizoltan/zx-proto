...
// Define auth routes helper or inline them
...
export const createUIApp = () => {
  ...
  // Auth Routes
  ui.route('/', createAuthRoutes());

  return ui;
};

// Moved imports to top-level below, but they should be at the top of file.
// Merging them with top imports.
  const html = await renderPage(LoginPage, {
    layout: AuthLayout,
    title: 'Sign In - IMS Shopfront'
  });
