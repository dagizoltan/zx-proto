  ...
  return (
    <div class="price-lists-page">
      <div class="page-header">
        <h1>Price Lists</h1>
        <a href="/ims/catalog/price-lists/new" class="btn btn-primary">Create Price List</a>
      </div>
              ...
              {priceLists.length > 0 ? (
                priceLists.map(pl => (
                  <tr>
                    ...
                    <td>
                        <a href={`/ims/catalog/price-lists/${pl.id}`} class="btn btn-sm btn-secondary">View</a>
                    </td>
                  </tr>
                ))
              ) : (
