  ...
  return (
    <div class="purchase-orders-page">
      <div class="page-header">
        ...
        <a href="/admin/purchase-orders/new" class="btn btn-primary">Create PO</a>
      </div>
            ...
            <tbody>
              {purchaseOrders.map(po => (
                <tr>
                  ...
                  <td>
                    <a href={`/admin/purchase-orders/${po.id}`} class="btn btn-sm btn-secondary" style="margin-right: 0.25rem;">View</a>
                    {['DRAFT', 'ISSUED', 'PARTIAL'].includes(po.status) && (
                        <a href={`/admin/purchase-orders/${po.id}/receive`} class="btn btn-sm btn-primary">Receive</a>
                    )}
                  </td>
                </tr>
              ))}
